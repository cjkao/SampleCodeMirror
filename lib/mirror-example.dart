...
/**
 * wrap codemirror with a panel for open and hide temporal code
 */
class CodeViewer{
   ...
   */
  CodeViewer([String docStr='', String title='code', String containerId='code-mirror-viewer', bool extStyle=false]){
    String ctnId= containerId;
    String _template=
         ''' 
<div draggable class="panel panel-default" class='$ctnId'>
